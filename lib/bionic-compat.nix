...
let
  fixLlvmPackages = { bionicFlags, final }: lfinal: lprev:
    let
      # Shared helper to inject Bionic headers and flags into LLVM runtime derivations
      ...
      # Common LLVM CMake configuration flags shared between libllvm and libclang
      commonCmakeFlags = [
